...
class WPCUSN_Post_Meta_Box {
	...
	public function auto_link_on_load() {
		...
		jQuery(document).ready(function($) {
			...
			if ($('#wpcusn-try-auto-link').length) {
				setTimeout(function() {
	...
	public function render_meta_box( $post ) {
		...
		<?php else : ?>
			...
			<p>
				<button type="button" class="button" id="wpcusn-try-auto-link" data-post-id="<?php echo esc_attr( $post->ID ); ?>" style="margin-top: 5px;">
			...
			<p>
				<label for="wpcusn-manual-task-id"><strong><?php esc_html_e( 'Or link manually:', 'wpcusn' ); ?></strong></label><br />
				<input type="text" id="wpcusn-manual-task-id" placeholder="<?php esc_attr_e( 'Enter ClickUp Task ID', 'wpcusn' ); ?>" class="regular-text" style="margin-top: 5px;" />
				<button type="button" class="button" id="wpcusn-link-task" data-post-id="<?php echo esc_attr( $post->ID ); ?>" style="margin-top: 5px;">
